...
- Confirmed: deliver destination registry and validation backend
- Confirmed: deliver destination-management UI on top of that backend
- Confirmed: keep Unraid mount-safety guidance explicit in both backend validation and docs
- Confirmed: keep planning and handoff materials local to this project workspace
