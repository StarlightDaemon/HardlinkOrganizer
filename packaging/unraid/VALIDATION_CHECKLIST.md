# Hardlink Organizer — Validation Checklist (v1.0.0)

This checklist provides a structured procedure for an operator to validate Hardlink Organizer (v1.0.0) on a real Unraid host.
